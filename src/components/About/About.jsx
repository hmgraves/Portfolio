	...
	return (
		<div className="about-container" id="about">
			...
			<div className="about-text">
				...
				<br />
				<br />
				I successfully completed the Software Engineering Immersive program from General Assembly, as well as a Bachelor of Science in Biology from Oregon State University.
				<br />
				<br />
